...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2017 at 03:37 AM
...
CREATE TABLE `enquiries` (
  ...
  `enquiry` varchar(800) NOT NULL,
  `dateCreated` varchar(50) NOT NULL,
  `response` varchar(800) DEFAULT NULL,
  `dateResponded` varchar(50) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `file_attachment` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `enquiries` (`ticket_ID`, `stud_ID`, `type`, `enquiry`, `dateCreated`, `response`, `dateResponded`, `status`, `file_attachment`) VALUES
(4, 1401001, 'REFUND APPLICATON', '[ 2017/04/24 12:40:36 ]\nBritney Coone with ID#: 1401001 want a refund on the amount $30000.0 (FEE ID#: 10023).\n[ ENQUIRY ]\nrefund is the real g.', '2017/04/24 12:40:36', 'new code', '2017/04/25 16:30:11', 'Closed', 'n/a'),
(5, 1401001, 'FINANCIAL CLEARANCE APPLICATON', '[ 2017/04/24 12:41:45 ]\nBritney Coone with ID#: 1401001 want to apply for  financial clearance.\n[ ENQUIRY ]\n [ Please state your enquiries here ]...', '2017/04/24 12:41:46', 'Miss, you have already been cleared.', '2017/04/25 16:39:24', 'Closed', 'n/a'),
(6, 1401001, 'FINANCIAL CLEARANCE APPLICATON', '[ 2017/04/24 13:13:04 ]\nBritney Coone with ID#: 1401001 want to apply for  financial clearance.\n[ ENQUIRY ]\n [ Please state your enquiries here ]...', '2017/04/24 13:13:04', 'You have already been cleared.', '2017/04/25 16:37:29', 'Closed', 'n/a'),
(7, 1401010, 'FINANCIAL CLEARANCE APPLICATON', '[ 2017/04/24 14:10:26 ]\nWilliam Chen with ID#: 1401010 want to apply for  financial clearance.\n[ ENQUIRY ]\n [ Please state your enquiries here ]...', '2017/04/24 14:10:26', 'lol', '2017/04/25 16:28:38', 'Closed', 'n/a');
...
(207138, '2017-04-13', NULL, 'Open', 'Applying for fiancial clearance', '3'),
(273067, '2017-04-13', NULL, 'Open', 'Applying for fiancial clearance', '3'),
(300001, '2017-03-16', NULL, 'Open', 'I want to withdrawn from a module but I cannot do so online.', '3'),
(300002, '2017-03-27', '2017-03-28', 'Closed', 'My semester fee breakdown is not correct.', '4'),
(300008, '2017-02-01', '2017-02-10', 'Closed', 'I want to apply for a refund for my tuition.', '3'),
(300012, '2017-03-01', '2017-03-07', 'Closed', 'Need to understand why my account has a negative balance.', '2'),
(300013, '2017-03-06', '2017-03-10', 'Closed', 'I have paid my full tuition but I have not been give financial clearance.', '3');
...
INSERT INTO `student` (`stud_ID`, `firstName`, `lastName`, `email`, `accountBal`, `telephoneNum`, `clearance_status`, `Semester Cost`) VALUES
(1401001, 'Britney', 'Coone', 'britneycoone@gmail.com', 5000, '1(876)6782937', 'cleared', 82000),
(1401010, 'William', 'Chen', 'williamchen@gmail.com', 250000, '1(876)1234567', 'cleared', 35000),
(1401020, 'Goku', 'Sama', 'gokusama@gmail.com', 50000, '1(876)9098080', 'cleared', 56000),
(1401030, 'Naruto', 'Uzumaki', 'narutouzumaki@yahoo.com', 0, '1(876)5323845', 'not cleared', 55000),
(1402002, 'Lee', 'Jones', 'leejones@yahoo.com', 67000, '1(876)9873564', 'not cleared', 89000),
(1403003, 'Jessica', 'James', 'jessicajames@gmail.com', 98000, '1(876)6475837', 'not cleared', 0),
(1404004, 'Leanna', 'Dimester', 'leannadimester@yahoo.com', 95000, '1(876)4675938', 'cleared', 0),
(1404040, 'Itachi', 'Uchiha', 'itachiuchiha@killmyfam.com', 500000, '1(876)5673488', 'cleared', 0),
(1405005, 'Dexter', 'Deedee', 'dexterdeedee@lab.com', 0, '1(876)5437594', 'cleared', 0),
(1405050, 'Sakura', 'Something', 'sakura@pink.com', 25000, '1(876)4560998', 'not cleared', 0),
(1406006, 'Jak', 'Daxter', 'jakdaxter@oracle.com', 9, '1(876)1357975', 'cleared', 0),
(1406060, 'John', 'Doe', 'johndoe@live.com', 50000, '1(876)9873564', 'not cleared', 0),
(1406949, 'Wembley ', 'Williams', 'wembleywilliams@hello.com', 0, '1(876)9876789', '', 0),
(1406952, 'David', 'Rhoden', 'davidrhoden@live.com', 25000, '1(876)4566543', '', 0),
(1407007, 'Jon', 'Snow', 'jonsnow@unknown.com', 1500000, '1(876)9087656', '', 0),
(1407070, 'Alex', 'Smith', 'alexsmith@lexi.com', 0, '1(876)3749279', '', 0),
(1408008, 'Beyonce', 'Knows', 'beyonceknows@lemonade.com', 0, '1(876)8888888', '', 0),
(1408080, 'Adrian', 'Matthews', 'adrianmatthews@live.com', 500, '1(876)3458293', '', 0),
(1409009, 'Rihanna', 'Diamond', 'rihannadiamond@shine.com', 0, '1(876)2050205', '', 0),
(1409090, 'Jillian', 'James', 'jillianjames@live.com', 250, '1(876)4567893', '', 0);
...
INSERT INTO `student_module` (`ID`, `stud_ID`, `module_Name`, `Cost`) VALUES
(1, 1401001, 'Information Technology', 23000),
(2, 1401001, 'Computer Security', 34000),
(3, 1401001, 'Mathematics', 25000),
(4, 1401010, 'Academic Writing', 20000),
(5, 1401010, 'Environmental Studies', 15000),
(6, 1401020, 'Calculus 1', 24000),
(7, 1401020, 'Theory of Computation', 32000),
(8, 1401030, 'Networks', 15000),
(9, 1401030, 'Physics', 40000),
(10, 1402002, 'Database Design', 25000),
(11, 1402002, 'Advanced Programming', 50000),
(12, 1402002, 'Research Methods', 14000);
...
--
ALTER TABLE `student_module`
  ADD CONSTRAINT `fk_student_ID` FOREIGN KEY (`stud_ID`) REFERENCES `student` (`stud_ID`);
