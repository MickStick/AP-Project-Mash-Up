...
public class Response implements ResponseMethods,Serializable{
	...
	private Enquiry enobj;
	private ArrayList<Enquiry> enobjs;
	...
	public Enquiry getEnquiryObject(){return enobj;}

	public void setEnquiryObj(Enquiry enobj){this.enobj = enobj;}

	public void setEnquiries(ArrayList<Enquiry> enobjs){
		this.enobjs = enobjs;
	}
	...
	public void setEOS(EmpOnServer eosobj){
		this.eosobj = eosobj;
	}
	public EmpOnServer getEOS(){return eosobj;}
