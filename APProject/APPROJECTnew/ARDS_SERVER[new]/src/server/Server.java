		...
		public void run(){
			try{
					...
					if(mail.getUser().equals("EMPLOYEE")){
						...
						System.out.println("checks for <Login> message");
						case "Login":
							System.out.println("id: "+mail.getUserID()+" password: xxxxx");
							...
							System.out.println("checks for <Enquiries> message");
						case "Enquiries":
							System.out.println("eytdjdjdt");
							if(sessionLive(mail.getSession())){
							...
							System.out.println("checks for <goOnline> message");
						case "goOnline":
							if(sessionLive(mail.getSession())){
								employeesOnline.add("");//Add Firstname Lastname Hostname Port; as one string.
							}
							
							System.out.println("checks for <goOffline> message");
						case "goOffline":
							if(sessionLive(mail.getSession())){
								employeesOnline.remove("");//Remove from list
							}
						
							System.out.println("checks for <Logout> message");
						case "Logout":
							if(sessionLive(mail.getSession())){
								killSession(String.valueOf(mail.getSession()));
								mail.setSession(0);
							...
							default:
								System.out.println("it comes here if it doesn't work");
								System.out.println(">> wrong supmn yuh sen!");
								break;
						}
					}
