...
public class StudentQueryFactory {
	...
	public static void saveEnquiry(int studentID, String enquiry, File file){
		...
		try{
			stt = con.createStatement();
			String query = "INSERT INTO enquiries (stud_ID, type, enquiry, dateCreated, file_attachment)"
					+"VALUES ('"+studentID+"','"+enquiryType[0]+"','"+enquiry+"','"+datecreated+"','"+filename+"');";
			stt.execute(query);
